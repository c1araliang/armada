...
| 4 | [Quijano (2000)](https://doi.org/10.1215/01642472-13-3_4-533) Coloniality of Power | Latin American studies | Coloniality of power / Eurocentrism as a structuring global axis; motivates the postcolonial frame for F3BF's target/contrast group partition | **Theory** | `postcolonial` `lexicon-foundation` |
...
| # | Study | Target | Key method | Goal | Tags |
|:---|:---|:---|:---|:---|:---|
| 1 | [Su et al. (2021)](https://arxiv.org/abs/2103.15316) BERT-Whitening | BERT and sentence-BERT embeddings | Post-hoc whitening transformation to stretch anisotropic cone into isotropic distribution; improves semantic STS and retrieval | **Methodology / diagnostic** | `representation-mechanism` `anisotropy` |
| 2 | [Wdowicz (2025)](https://doi.org/10.1007/s43681-024-00584-2) Not a Mirror, a Caricature | GPT models prompted with American / Polish / Japanese identity cues | Self-Construal Scale (30 items); models produce fully separated, near-zero within-culture variance profiles — caricature rather than mirror; anglocentric default in 75% of neutral conditions | **Analysis** | `representation-mechanism` `demographic-profiling` |

- Su (#1) provides the mathematical corrective baseline: if post-hoc whitening recovers semantic axes, the cone effect (Ethayarajh) is the proximate cause of animacy entanglement, not irreducible feature interference.
...
| # | Study | Target | Key method | Goal | Tags |
|:---|:---|:---|:---|:---|:---|
| 1 | [Ghai, Hoque & Mueller (CHI 2021)](https://doi.org/10.1145/3411763.3451755) WordBias | Static word embeddings | Relative Norm Difference across multiple demographic axes (race × gender × religion); parallel-coordinate visualization of intersectional bias distribution | **Detection** | `intersectional` `visualization` `polysemy` |
...
| 8 | [Zhang et al. (EMNLP 2024)](https://aclanthology.org/2024.emnlp-main.10/) mGTE | GTE-ModernBERT encoder for frame-refresh, WEAT, CEAT, CEAT-full, and AttI prototype scoring |
...
see the latest version of [bibliography](https://raw.githubusercontent.com/c1araliang/armada/refs/heads/main/My%20Library.bib) 
